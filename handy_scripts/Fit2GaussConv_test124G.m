function [estimates,ConvRescaleFactor,ErrorVector,SumSquares,w_num_pts] = Fit2GaussConv(ydata, ref, SD1, SD2, SD4)
...
%        gsum=(w1*g1+w2*g2+w3*g3+w4*g4)/trapz(w1*g1+w2*g2+w3*g3+w4*g4);
                gsum=(w1*g1+w2*g2+w4*g4)/trapz(w1*g1+w2*g2+w4*g4);
        temp=ref;
