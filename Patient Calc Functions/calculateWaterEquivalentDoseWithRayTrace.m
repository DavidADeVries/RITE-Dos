...
waterEquivDose_SourceToIsocentre = imrotate(reshape(waterEquivDose_SourceToIsocentre, epidDetectorDims),-90);
waterEquivDose_IsocentreToEPID = imrotate(reshape(waterEquivDose_IsocentreToEPID, epidDetectorDims),-90);
